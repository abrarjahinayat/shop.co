        ...
        <div className="flex">
          ...
          <div className="flex  items-center justify-between" >
            ...
            <div className="flex items-center gap-x-3">
              <p className="font-oswald font-medium text-base text-black/60">Showing 1-10 of 100 Products</p>
              <div className="flex items-center gap-x-2">
                <p className="font-oswald font-medium text-base text-black/60">Sort by:</p>
                <div className="flex items-center gap-x-1 cursor-pointer ">
                  <p className="font-oswald font-medium text-base text-black">Most Popular</p>
            ...
            <div className="flex justify-between items-center py-10">
                <div className="flex items-center cursor-pointer gap-x-2 px-3 border rounded-md bg-white">
                    <IoMdArrowRoundBack />
                    <button className="text-lg py-1 text-black">Previous</button>
                </div>
                <div className="flex items-center gap-x-2 border px-4 rounded-md bg-white">
                    <button className="text-lg text-black  py-1">Next</button>
